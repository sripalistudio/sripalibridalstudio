                        ...
                        >
                                ...
                                <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'flex-start' }}>
                                    ...
                                    <div>
                                        ...
                                        <p style={{ color: 'var(--color-text-secondary)' }}>
                                            <a href="mailto:reepthika@gmail.com" style={{ color: 'inherit', textDecoration: 'none' }}>reepthika@gmail.com</a>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <div style={{ display: 'flex', gap: '1rem' }}>
                                    <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" style={{ background: 'rgba(198, 168, 124, 0.1)', padding: '0.8rem', borderRadius: '50%', color: 'var(--color-gold)', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.3s' }}>
                                        <Facebook size={20} />
                                    </a>
                                    ...
                                    <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" style={{ background: 'rgba(198, 168, 124, 0.1)', padding: '0.8rem', borderRadius: '50%', color: 'var(--color-gold)', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.3s' }}>
                                        <Youtube size={20} />
                                    </a>
                                </div>
                            </div>
